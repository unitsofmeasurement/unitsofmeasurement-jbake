    ...
    <footer>
      <div class="container">
        ...
        <div class="row">
          <div class="col-xs-10">
            <p class="text-muted credit">&copy; ${config.site_copyright} 2022 | Mixed with <a href="http://getbootstrap.com/">Bootstrap v3.1.1</a> | Baked with <a href="http://jbake.org">JBake ${version}</a> | <i title="Linux" class="fa fa-linux"></i></p>
          </div>
